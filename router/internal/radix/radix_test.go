...
func qs(slots []*radix.Slot) string {
	var out []string
...
func TestSlots(t *testing.T) {
	...
	okp(t, &test{
		...
		requests: []*request{
			{path: "/v2", route: "/v{version}", slots: "version=2"},
			{path: "/v2.0.1", route: "/v{major}.{minor}.{patch}", slots: "major=2&minor=0&patch=1"},
			{path: "/v1", route: "/v1"},
			{path: "/v2.0.0", route: "/v2.0.0"},
		},
	})
}
