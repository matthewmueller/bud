...
import (
	...
	"github.com/matthewmueller/bud/internal/modcache"
	"github.com/matthewmueller/bud/internal/testdir"
...
func TestResolveDirectoryNestedSame(t *testing.T) {
	...
	module, err := gomod.Find(wd, gomod.WithModCache(modCache))
	is.NoErr(err)
	dir, err := module.ResolveDirectory("github.com/matthewmueller/bud/internal/modcache")
	is.NoErr(err)
...
func TestOpen(t *testing.T) {
	...
	is.NoErr(err)
	is.Equal(true, contains(des, "go.mod", "go.sum"))
}
...
func TestModuleFindLocal(t *testing.T) {
	...
	module2, err := module1.Find(module1.Import("app"))
	is.NoErr(err)
...
func TestModuleFindFromFS(t *testing.T) {
	...
	vfs := virtual.Map{
		"imagine/imagine.go": `package imagine`,
	}
...
func TestSubFS(t *testing.T) {
	...
	is.NoErr(err)
	is.Equal(true, contains(des, "testdir", "current"))
}
